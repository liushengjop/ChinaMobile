...
public class PullToRefreshListViewExtend extends PullToRefreshAdapterViewBase<ListViewExtend> {
	...
	protected ListViewExtend createListView(Context context, AttributeSet attrs) {
		final ListViewExtend lv;
	...
	@Override
	protected ListViewExtend createRefreshableView(Context context, AttributeSet attrs) {
		ListViewExtend lv = createListView(context, attrs);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
			...
			OverscrollHelper.overScrollBy(PullToRefreshListViewExtend.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);

			return returnValue;
		}
	}

	protected class InternalListView extends ListViewExtend implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshListViewExtend.this.setEmptyView(emptyView);
		}
