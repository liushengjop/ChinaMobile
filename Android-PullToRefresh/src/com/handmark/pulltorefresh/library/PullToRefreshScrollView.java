...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollViewExtend1> {
	...
	@Override
	protected ScrollViewExtend1 createRefreshableView(Context context, AttributeSet attrs) {
		ScrollViewExtend1 scrollView;
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			scrollView = new InternalScrollViewSDK9(context, attrs);
		} else {
			scrollView = new ScrollViewExtend1(context, attrs);
		}
	...
	@TargetApi(9)
	final class InternalScrollViewSDK9 extends ScrollViewExtend1 {
